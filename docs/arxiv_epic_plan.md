...
### Task 2.1: Rich DTOs
- **Subtask 2.1.1:** Extend `crates/core/src/paper.rs` to include DOIs, journal references, and author affiliations.
- **Subtask 2.1.2:** Update the `quick_xml` parser loop to capture these new fields gracefully without failing on missing data.
